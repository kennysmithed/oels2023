...
and the base names of the target and foil pictures. It works out the path and 
full filename for the audio file, and then returns an audio-button-response 
trial using that stimulus plus the two images as choices.
