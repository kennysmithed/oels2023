...
wait_counter, which starts at 0 and increases by 1 every time the participant 
completes a picture selection or description trial. We then have a simple if-statement that 
sets the random wait depending on the value of wait_counter.
*/
